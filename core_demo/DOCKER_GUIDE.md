# Docker Reference — Core v1.6 Demo

This is the Docker reference for the **core SpatialDDS v1.6 protocol demo** (the
...
| Run v1.6 test | `docker run --rm --network host cyclonedds-python python3 spatialdds_test.py` |
